...
@_spi(SI_SPI) public extension Image {
    ...
    static let sparkCopyOutline = Image("copyOutline", bundle: .current)
    ...
    static let sparksSparks = Image("sparks", bundle: .current)
...
@_spi(SI_SPI) public extension UIImage {
    ...
    static let sparksSparks = UIImage(named: "sparks", in: .current, with: nil) ?? UIImage()
